...
This repository contains the code for the paper: "Few-Shot Aspect Extraction using Prompt Training".
...
- `DATASET` can be `lap`/`res`/`device` for Laptop, Restaurant and Digital Device
